...
class DatabaseService {
  ...
  Future<void> addPDFData(pdfData)async{
    await Firestore.instance.collection("Pdf").add(pdfData).catchError((e){
      print(e.toString());
    });
  }
  
  getPdfData()async{
    return await Firestore.instance.collection("Pdf").snapshots();
  }
